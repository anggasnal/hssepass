...
if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] != true) {
    ...
    if ($level == "admin") {
        ...
        if($demo){
            ...
            $sql = "SELECT * FROM cbt_user WHERE username='" . $username . "'";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                if (!empty($username) && !empty($password) && !empty($email)) {
                    ...
                    echo $sql = "INSERT INTO cbt_user (dateCreated,username,password,email,accesslevel,extensions,quota,active,filesize,upload_dir,upload_dirs)
        ...
        if($demo){
            ...
            if (is_array($_POST['usersToDel'])) {
                if (join(",", $_POST['usersToDel']) != '') {
                    $sql = "DELETE  FROM cbt_user WHERE id IN ('" . join("','", $_POST['usersToDel']) . "')";
                ...
                $sql = "DELETE  FROM cbt_user WHERE id='" . $usersToDel . "'";
