...
<body>
    <div id="header">
        ...
        <h1><a href="main.php"><img src="../public/newtemplate/images/icon-landscape.png"></a></h1>

    <span>
      Selamat Datang, <strong><?php echo getUser($_SESSION["idUser"]); ?></strong>!&nbsp;
        <a href="profile.php">Profil</a>&nbsp;/&nbsp;<a href="../index.php/welcome/logout">Keluar</a> <img src="images/icons/icon_power.png" width="10" height="12" />
    </span>
    </div>
