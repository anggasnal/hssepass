 ...
 * #*******************************************************************************/
      ...
      //create users
            ...
            if(mysqli_query($mysqli,$query)){
              $tt .= "Created table 'cbt_user' (8/8)<br/>";
         //create admin

            $query="INSERT INTO `cbt_user` (`id`,`dateCreated`, `username`, `password`, `email`, `extensions`, `quota`, `filesize`, `active`, `last_login`, `accesslevel`, `upload_dir`, `upload_dirs`)
            ...
            } else { $tt .= "<div class=error><b>ERROR!</b> can't create cbt_user (8/8)!<br /></div>"; $BWContinue = false; }
