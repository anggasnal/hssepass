...
function getUser($userID)
{
    ...
    $sqll = "SELECT id,username FROM cbt_user WHERE id='" . $userID . "'";
...
{
    global $db_pr; global $mysqli;
    $sqll = "SELECT id,upload_dir FROM cbt_user WHERE id='" . $user . "'";
    $result1 = mysqli_query( $mysqli,$sqll);
    $row11 = mysqli_fetch_assoc($result1);
...
{
    global $db_pr; global $mysqli;
    $sqll = "SELECT id,username,email FROM cbt_user WHERE id='" . $userID . "'";
    $result1 = mysqli_query( $mysqli,$sqll);
    $row11 = mysqli_fetch_assoc($result1);
    $processor = array();
