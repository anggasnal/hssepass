...
if($demo){
    ...
    foreach ($ids as $id) {
        ...
        $sql = "SELECT * FROM cbt_user WHERE extensions LIKE '%{$extData['name']}%' ";
        //print $sql;
        ...
        while ($row = mysqli_fetch_assoc($res)) {
            ...
            mysqli_query($mysqli, "UPDATE cbt_user SET extensions ='" . implode(',', array_flip($_usrExt)) . "' WHERE id='{$row['id']}'");
        }
