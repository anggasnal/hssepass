            ...
            <div class="col">
                ...
                <table class="stat">
                    ...
                    $sql = "SELECT d.*,u.username,(SELECT COUNT(id) FROM {$db_pr}downloads WHERE idUser=d.idUser AND date > '" . date("Y-m-d 00:00:00") . "') as total,
                                        ...
                                        INNER JOIN cbt_user u ON u.id=d.idUser
