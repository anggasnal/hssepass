...
if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] != true) {
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function viewPdf(path) {
            $("#pdfValue").html($.colorbox({href: "includes/pdf/web/viewer.php?pdf=" + path, className: "inline", iframe: true, width: "96%", height: "100%"}));
        }
    ...
    <div id="content-main">
            ...
            <form action="#" id="formTable">
                <table cellpadding="0" cellspacing="0" border="0" class="display lra" id="table">
                    ...
                    <tr>
                        ...
                        <th width="8%">Ekstensi</th>
                        <th width="10%">Folder</th>
                        <th width="20%">Tangggal Unggah</th>
                        <th width="18%">Url</th>
                    </tr>
                    </thead>
                    <tbody>
        ...
        <br/><br/>
        <button id="btndeleteselected" class="btn btn-danger ">Hapus Terpilih</button>
    </div>
    <br/><br/>
