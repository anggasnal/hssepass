...
class Services extends CI_Controller {
    ...
    function get_pekerja_aktif(){
        ...
        $qtotal = $this->paket_pekerjaan_model->get_count_paket_aktif($kolom = "paket_pekerjaan_pekerja.pic_masuk", $isian)->result();
        $totalData = $qtotal[0]->hasil;
        ...
        $query_pekerjaan = $this->paket_pekerjaan_model->get_paket_aktif($start=0, $rows=1000, $kolom = "paket_pekerjaan_pekerja.pic_masuk", $isian);
        ...
        if($this->form_validation->run() == TRUE){
            ...
            if($this->form_validation->run() == FALSE){
                ...
                if($data->mitra_id == "1"){
                    ...
                    $status['status'] = 0;
                    $status['result'] = "<p>Username yang dimasukkan tidak diizinkan</p>";
                }
            }
        }else{
            $status['status'] = 0;
