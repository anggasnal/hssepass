    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/home" class="logo">
          ...
          <span class="logo-mini"><img src="<?php echo base_url(); ?>public/newtemplate/images/icon-landscape.png" alt="logo" /></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="<?php echo base_url(); ?>public/newtemplate/images/icon-landscape.png" alt="logo" /></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li><a href="<?php echo site_url(); ?>/manager/dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
      ...
      <footer class="main-footer">
        ...
        <b>&copy; 2019 Project Management Office</b>
      </footer>
