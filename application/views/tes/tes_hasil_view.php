                ...
                <div class="box-body form-horizontal">
                    ...
                    <div class="col-xs-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="pilih-nama" id="pilih-nama" class="form-control" placeholder="Nama Peserta" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-2">
        ...
        <div class="col-xs-12">
			<div class="box">
                ...
                <div class="box-footer">
					...
					<button type="button" id="btn-edit-hapus" class="btn btn-primary">Buka Tes</button>
...
<script lang="javascript">
    ...
    function detail_tes(tesid){
        window.open("<?php echo site_url().'/manager/tes_hasil_detail'; ?>/index/"+tesid);
    }
	...
	$('#pilih-tes').select2();
        ...
        $('#table-hasil').DataTable({
                  ...
                  "fnServerParams": function ( aoData ) {
                    ...
                    aoData.push( { "name": "nama", "value": $('#pilih-nama').val()} );
                  }
         });          
    });
</script>
