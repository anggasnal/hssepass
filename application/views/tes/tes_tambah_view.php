...
function on_change_lokasi(el){
	var selectedOption = el.target.value;
	var d = new Date();
	$('#tambah-nama').val(selectedOption + " " + d);
}
</script>
                ...
                <div class="box-body">
                    <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" name="tambah-nama" id="tambah-nama" class="form-control input-sm" style="display:none;"/>
								<select name="tambah-lokasi" id="tambah-lokasi" class="form-control input-sm" onchange='on_change_lokasi(event)'>
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <div class="col-sm-9">
                                <textarea name="tambah-deskripsi" id="tambah-deskripsi" class="form-control input-sm" >Tes Ujian HSSE PASS No <?php echo base64_encode(date("Y-m-d H:i:s"))?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="tambah-waktu" id="tambah-waktu" class="form-control input-sm" value="10" />
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="tambah-poin" id="tambah-poin" class="form-control input-sm" value="1.00" readonly/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="tambah-detail-hasil" id="tambah-detail-hasil" value="1" checked>
                ...
                <div class="box-body">
                    <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control input-sm" id="soal-tipe" name="soal-tipe" disabled>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Type Soal</label>
                            <div class="col-sm-9">
                                <select class="form-control input-sm" id="soal-kesulitan" name="soal-kesulitan" disabled>
                                    <option value="1">Worker</option>
                                    <option value="2">Line Management</option>
...
<script lang="javascript">
    ...
    function edit(id){
        ...
        $.getJSON('<?php echo site_url().'/'.$url; ?>/get_by_id/'+id+'', function(data){
            if(data.data==1){
				...
				var x = $('#tambah-group').val();
				$('#soal-kesulitan').val(x);
            }
            $("#modal-proses").modal('hide');
        });
    }
    ...
    $(function(){
        $('#tambah-rentang-waktu').daterangepicker({timePicker: true, timePickerIncrement: 30, format: 'YYYY-MM-DD'});
