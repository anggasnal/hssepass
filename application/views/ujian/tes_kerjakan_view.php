<div class="container">
    ...
    <section class="content">
        ...
        <?php echo form_open('tes_kerjakan/simpan_jawaban','id="form-kerjakan"')?>
            ...
            <input type="hidden" name="tes-user-id" id="tes-user-id" value="<?php if(!empty($tes_id)){ echo $tes_id; } ?>">
        ...
        <div class="row">
            <div class="box box-success box-solid">
                ...
                <div class="box-footer">
                   <button class="btn btn-default pull-right" id="btn-hentikan">Selesai</button>
                </div>
            </div><!-- /.box -->
        </div>
    </section><!-- /.content -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="trx-judul">Konfirmasi Selesai</div>
                </div>
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="callout callout-info">
                                <p>Apakah anda yakin mengakhiri ujian Tema ini ?
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="hentikan-centang" name="hentikan-centang" value="1"> Centang dan klik tombol Selesai.
                                    </label>
                                </div>
                            </div>
                        </div>
    ...
    function hentikan_tes(){
        ...
        $.getJSON('<?php echo site_url().'/'.$url; ?>/get_tes_info/'+$('#tes-id').val(), function(data){
            if(data.data==1){
                ...
                $('#hentikan-tes-user-id').val(data.tesuser_id);
